...
function Project() {
  ...
  const closeModal = () => {
   ...
   const settings = {
    ...
    slidesToScroll: 1,
    pauseOnHover: true,
    centerMode: true, // centerMode 옵션을 추가
    centerPadding: '-20vw', // 슬라이드가 좌우로 20vw씩 보여지도록 설정합니다.
    arrows: false, 
...
// 
  return (
    <div>
      ...
      <div  className="bg-black h-full  py-[10vh]">
        <img src='/Image/background1.jpg' alt="bg" className={`absolute top-0 left-0 w-full h-[110vh] object-cover `} />
        
      <p className="absolute top-[3rem] left-1/2 z-30  transform -translate-x-1/2 text-violet text-[4.3vw]"> 클릭해서
      프로젝트 상세보기 </p>
      <div className='absolute top-[5rem]  left-[42vw]  blinking-text font-face' >Slide → </div>;
        <div className="absolute w-[100vw] h-[100vh] z-30 text-center " >
          <Slider {...settings} >
            <ProjectCard
              ...
              onClick={() =>
                openModal({
                  ...
                  learn: [
                    ...
                    'PWA로 개발속도를 높였고, 접근성을 확대하고, 반응형 디자인을 적용했습니다',
                  ],
                })
              }
              ...
              onClick={() =>
                openModal({
                  ...
                  learn: [
                    ...
                    'axios Instance를 활용해 api 코드 리팩토링을 진행하고 코드 최적화를 했습니다.',
                  ],
                })
              }
